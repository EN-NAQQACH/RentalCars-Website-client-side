  ...
  return (
    ...
    <div className='max-w-[70%] m-auto border-t-[1px] '>
        <div className='text-center flex flex-col gap-5 mt-[80px]'>
            <div>
                <p className='font-bold text-[16px] mb-[-17px]' style={{fontFamily:"Space Grotesk"}}>Discover the EaslyCars car rental marketplace</p>
            </div>
            <div>
                <p className='font-bold text-[40px]' style={{ fontFamily: "Playfair Display" }}>Rent cars in {destination}</p>
            </div>
        ...
        <div className='carsBymake max-w-[90%] m-auto h-lvh' style={{fontFamily:"Space Grotesk"}}>
        <div className='font-bold text-[18px]' style={{ fontFamily: "Space Grotesk" }}>
            Cars in {destination}
        </div>
            {/* <Link >
            ...
            <Link className='text-center flex justify-center m-auto rounded-md mt-8 border w-fit p-2 font-semibold text-[14px] text-white bg-[#5c3cfc] hover:bg-[#3d2b97]'>Rent Car in {destination}</Link>
        </div>
    </div>
</div>
  )
