                        ...
                        <div className='seo-carinfo-content '>
                            <div className='seo-aside-left '>
                                ...
                                <div className='seo-host-info mt-7'>
                                    <div className='seo-host-content border-t-[1px] border-gray-100'>
                                        <p className='text-[12px] font-semibold uppercase mb-2 mt-2'>Hosted By</p>
                                        <div className='flex items-center gap-[280px]'>
                                            <div className='flex items-center gap-3'>
                                                <div className='seo-host-photo w-[80px] h-[80px]'>
                                                    <img src="../../src/assets/carmain9.jpg" alt="" className='h-full w-full object-cover rounded-[50%]' />
                                                </div>
                                                <div className=''>
                                                    <p className='font-bold'>Mohssine E.</p>
                                                    <p className='text-gray-400 text-[13px]'>Joined 2024</p>
                                                </div>
                                            </div>
                                            <div className='contact-info'>
                                                <div className='flex items-center gap-3'>
                                                    <BsWhatsapp className='text-[28px] text-green-500 cursor-pointer transition-all duration-200 hover:translate-y-[-2px]' />
                                                    <BiMessageDetail className='text-[28px] text-blue-500 cursor-pointer transition-all duration-200 hover:translate-y-[-2px]' />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className='seo-car-info mt-7'>
                                    <div className='seo-car-content'>
                                        <p className='text-[12px] font-semibold uppercase mb-2'>Description</p>
                                        <div className='flex items-center gap-3'>
                                            <div className='seo-description text-[14px]'>
                                ...
                                <div className='seo-car-info mt-4'>
                                    <div className='seo-car-content'>
                                        <p className='text-[12px] font-semibold uppercase mb-2'>Features</p>
                                        <div className='flex gap-[100px] items-center'>
                                            <div className='flex flex-col gap-3'>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/steering-wheel.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Cruise Control</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/airbag.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Airbags</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/heat.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Leather Seats</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/location.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>GPS</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/car.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Air Conditioning</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/sun.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Sunroof</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/alloy-wheel.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Alloy Wheels</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/speedometer.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Speed Limiter</p>
                                                </div>
                                            </div>
                                            <div className='flex flex-col gap-3'>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/esp.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>ESP</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/parking.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Parking Radar</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/steering-wheel.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                ...
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/baby-car-seat.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Child seat</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/360-degree.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Rear View Camera</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/abs.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>ABS</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/window.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>Electric Windows</p>
                                                </div>
                                                <div className='seo-features flex items-center gap-3 text-[14px]'>
                                                    <img src="../../src/assets/bluetooth.png" alt="" className='object-cover h-[27px] w-[27px]' />
                                                    <p>CD/MP3/Bluetooth</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className='seo-aside-right ml-3'>
                                <div className='seo-aside-content'>
                                    ...
                                    <div className='seo-date-picker'>
                                        ...
                                        <div className='mt-7'>
                                            <div className='flex justify-between bg-gray-100 p-3 rounded-lg border-gray-200 border-[1px]'>
                                                <p>1-week discount</p>
                                                <p className='text-green-600'>$159</p>
                                            </div>
                                            <div className='mt-7'>
                                                <button className='text-center bg-[black] p-2 pb-3 pt-3 w-[100%] text-white rounded-md'>
                                                    Reserve
                                                </button>
                                            </div>
                                        </div>
                                        <div className='flex items-center gap-4 mt-7 border-t-[1px] border-b-[1px] pl-5 pb-5 pt-5'>
                                        ...
                                        <div className='flex items-center gap-4 mt-4 border-t-[1px] border-b-[1px] pt-5 pb-5 pl-5'>
                                            <div>
                                                <p className='text-[13px] font-bold mb-2 text-gray-400'>INSURANCE & PROTECTION</p>
                                                <p className='text-[12px]'> Insurance via Travelers</p>
                                            </div>
                                        </div>
                                        <div className='mt-7'>
                                                <button className='text-center  p-2 w-[100%] rounded-lg border-[1px] border-gray-300 text-gray-800'>
