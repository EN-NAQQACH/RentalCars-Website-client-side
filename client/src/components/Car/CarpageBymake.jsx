                ...
                <div className='max-w-[70%] m-auto border-t-[1px] '>
                    ...
                    <div className='carsBymake w-[100%] m-auto h-lvh'>
                        ...
                        <Swiper
                            ...
                            slidesPerView={2} // Number of slides per view (visible slides)
                        ...
                        >
                            {cars.map((car) => (
                                <SwiperSlide className='swiper-slid card w-[100%] h-[fit]' >
                                        ...
                                        <Link to={`/car/car-rental/${car.make}/${car.model}/${car.year}/${car.id}`}>
                                            <div className="car-card-components w-[100%]  h-[fit] border rounded-lg shadow-sm">
                                                ...
                                                <div className='mt-2 p-2'>
                                                    ...
                                                    <div className='flex gap-3 mt-2 flex-wrap max-w-[280px]'>
