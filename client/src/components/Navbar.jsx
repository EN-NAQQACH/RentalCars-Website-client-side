            ...
            <div className="w-full max-w-md p-4 bg-white rounded-lg ">
              ...
              <form className="space-y-4">
                <div className="flex flex-col">
                  ...
                  <input type="email" name="email" id="email2" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                </div>
                <div className="flex flex-col">
                  <label htmlFor="password2" className="text-sm font-medium mb-2">Password</label>
                  <input type={showPassword ? 'text' : 'password'} name="password" id="password2" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                ...
                <button type="submit" className="block w-full px-4 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-700">Sign in</button>
              </form>
            ...
            <div className="w-full max-w-md p-4 bg-white rounded-lg ">
              ...
              <form className="space-y-4">
                <div className="flex flex-col">
                  ...
                  <input type="text" name="firstName" id="firstname" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                </div>
                <div className="flex flex-col">
                  <label htmlFor="lastName" className="text-sm font-medium mb-2">LastName</label>
                  <input type="text" name="lastName" id="lastName" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                </div>
                <div className="flex flex-col">
                  <label htmlFor="email1" className="text-sm font-medium mb-2">Email address</label>
                  <input type="email" name="email" id="email1" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                </div>
                <div className="flex flex-col">
                  <label htmlFor="password2" className="text-sm font-medium mb-2">Password</label>
                  <input type={showPassword ? 'text' : 'password'} name="password2" id="password" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
                </div>
                <button type="submit" className="block w-full px-4 py-2 bg-blue-500 text-white font-medium rounded-lg hover:bg-blue-700">Sign in</button>
              </form>
            </div>
