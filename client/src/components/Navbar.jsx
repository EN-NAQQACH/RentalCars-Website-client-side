          ...
          <div className="w-full max-w-md p-4 bg-white rounded-lg ">
            ...
            <form className="space-y-4">
              <div className="flex flex-col">
                ...
                <input type="email" name="email" value={email} onChange={(e)=>setEmail(e.target.value)} id="email2" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
              </div>
              <div className="flex flex-col">
                <label htmlFor="password2" className="text-sm font-medium mb-2">Password</label>
                <input type={showPassword ? 'text' : 'password'} name="password" value={password} onChange={(e)=>setpassword(e.target.value)} id="password2" className="px-3 py-2 border rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-1" required />
